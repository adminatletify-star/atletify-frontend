 ...
 */
export default function OpcionesPicker({ valor, onCambiar, opciones = [], titulo = 'Selecciona', icono = 'fas fa-list-ul', placeholder = '— Selecciona —' }) {
  ...
  return (
    <>
      ...
      {abierto && createPortal(
        <div className="opk-overlay" onClick={() => setAbierto(false)}>
          <div className="opk-panel" onClick={e => e.stopPropagation()}>
            ...
            <div className="opk-header">
              ...
              <button type="button" className="opk-close" onClick={() => setAbierto(false)}>
