...
import './CategoriaBaseMasterPicker.css';
...
const OPCIONES = [
  ...
  { valor: 'RX',         label: 'RX / Avanzado', desc: 'Avanzado — pesos y movimientos completos',     icono: 'fas fa-medal',         key: 'rx'         },
  { valor: 'Master',     label: 'Master',     desc: 'Categoría para veteranos con gran experiencia',     icono: 'fas fa-crown',         key: 'master'     },
];

export default function CategoriaBaseMasterPicker({ valor, onCambiar }) {
          ...
          <div className="cbp-panel" onClick={e => e.stopPropagation()}>
            ...
            <div className="cbp-header">
              <span className="cbp-title">
                <i className="fas fa-layer-group"></i> Nivel Real (Anti-Trampas)
              </span>
