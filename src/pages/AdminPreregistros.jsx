...
export default function AdminPreregistros() {
  ...
  // Se han movido los estados de exportación al componente ExportarBDTab
      ...
      <div className="dash-hero pb-4 pt-5">
        <div className="container">
          ...
          <div className="d-flex gap-3 mt-4 border-bottom border-secondary pb-2 overflow-auto">
            ...
            <button className={`btn ${activeTab === 'auditoria' ? 'btn-secondary' : 'btn-outline-light'} px-4 rounded-pill fw-bold text-nowrap`} onClick={() => setActiveTab('auditoria')}><i className="fas fa-shield-alt me-2"></i>Logs Auditoría</button>
          </div>
        </div>
      </div>
