            ...
            {(!estaBaneado && expedienteVacio) || !estaBaneado ? (
              <form onSubmit={handleGuardarExpediente} className="sde-form mt-4">
                ...
                <div className="row g-3 g-lg-4">
                  <div className="col-12 col-sm-6 col-lg-4"><label className="sde-label">Peso (kg)</label><input type="number" step="0.1" required className="form-control sde-input" value={form.peso} onChange={e => setForm({...form, peso: e.target.value})} placeholder="70" /></div>
                  ...
                  <div className="col-12 col-sm-6 col-lg-6"><label className="sde-label">Deportes Previos (Opcional)</label><input type="text" className="form-control sde-input" value={form.deporteExperiencia} onChange={e => setForm({...form, deporteExperiencia: e.target.value})} /></div>
                  <div className="col-12"><label className="sde-label sde-label-warning"><i className="fas fa-exclamation-triangle me-2"></i>Lesiones o Condiciones Médicas</label><textarea className="form-control sde-input sde-textarea" value={form.tieneDiscapacidad} onChange={e => setForm({...form, tieneDiscapacidad: e.target.value})} rows="2" /></div>
                </div>
