...
const API_COBRANZA = `\${import.meta.env.VITE_API_URL}/api/cobranza`;
const API_PRECIO = `\${import.meta.env.VITE_API_URL}/api/precioespecial`;
  ...
  const cargarDatos = useCallback(async () => {
    ...
    try {
      ...
      const [resAtleta, resFinanzas, resDescuentos] = await Promise.all([
        ...
        fetch(`\${import.meta.env.VITE_API_URL}/api/finanzas/descuentos/${b.idBox}`, { headers: headersGet })
      ]);
