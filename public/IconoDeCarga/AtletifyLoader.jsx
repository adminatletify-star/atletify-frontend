...
import { interpolate } from "flubber"; // npm i flubber

// 18 vértices en ambos paths (1 M + 17 L + Z) → morph estable
// "A" stencil / disco de pesas (esquinas chaflanadas, ápice afilado)
const pathA =
...
// Hex Dumbbell con agarre ergonómico (más fino en el centro)
const pathDumbbell =
    ...
    return (
        <div className="d-flex justify-content-center align-items-center">
            <svg
                ...
                // text-white + glow vía drop-shadow → loader "vivo"
